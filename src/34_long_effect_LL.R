...
#-------------------------------------------------------------------------------
# Obtaining cohort life expectancy for all countries using the Li-Lee
...
#were obtained forecasting with the Li-Lee using data until 2019.
...
#with the Li-Lee using data until 2019.
