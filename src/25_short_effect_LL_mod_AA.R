...
# Short-term effect - Li-Lee modified auto ARIMA
...
#with the Li-Lee modified AA using data until 2019.
...
write.table(
  ...
  row.names = F,
  "out/25_lmx_short_LL_mod_AA.txt")


# period e0 obs & forecast
save(period_e0,file="out/25_period_e0_LL_mod_AA.Rdata")
